        ...
        <div class="mycontainer">
            <div class="game-list">
                ...
                <div style="display: flex;flex-wrap: wrap;">
                    ...
                    <el-dialog title="想法详情" :visible.sync="dialogTableVisible" width="40%">
                        ...
                        <div class="gamecard">
                            ...
                            <div class="gamecard-body">
                                ...
                                <div class="game-info">
                                <p>想法所属领域: {{nowitem.manufacturer}}</p><br>
                                <p>想法简介: {{nowitem.description}}</p>
                                </div>
            ...
            <div style="display: flex;justify-content: center;">
                ...
                <el-button type="success" @click="addgames" plain style="margin: 10px 15px;"><i class="el-icon--left el-icon-plus"></i>添加想法</el-button>
            </div>
            ...
            <el-form :model="gameForm" ref="gameForm" label-position="left" label-width="110px" label-align="left">
                <el-form-item label="想法名称" prop="name">
                <el-input v-model="gameForm.name" required></el-input>
                </el-form-item>
                <el-form-item label="想法所属领域" prop="developer">
                <el-input v-model="gameForm.developer" required></el-input>
                </el-form-item>
                <el-form-item label="想法简介" prop="description">
                <el-input type="textarea" resize="none" v-model="gameForm.description" required></el-input>
                </el-form-item>
                <el-form-item label="想法图片链接" prop="imageUrl">
                <el-input v-model="gameForm.imageUrl" required></el-input>
                </el-form-item>
            </el-form>
            <span style="color:rgb(0, 179, 255);">tips：这里虽然可以随意想象，但一定要在法律允许的范围内！管理员会有审核，如有疑问，请联系管理员QQ：2012190160。</span>
            <!-- 按钮 -->
    ...
    methods:{
        ...
        initdys(){
            ...
            if(this.nowuid!=null&&this.nowuid!=''){
                    ...
                    getdylike(5,this.nowuid).then(res=>{
                        if(res.data.code==200){
                    ...
                    getdydislike(5,this.nowuid).then(res=>{
                        if(res.data.code==200){
        ...
        submitForm() {
            ...
            if(this.gameForm.name.length<1){
                ...
                this.$message({
                    message: '想法简介太长，请简化一下',
                    type:'warning'
                });
            }else if(this.gameForm.imageUrl.length>600){
                this.$message({
                    message: '想法图片链接太长，请更换链接',
                    type:'warning'
                });
            }else{
                ...
                additem(game).then(res=>{
                    if(res.data.code!=200){
                        ...
                        this.$message({
                            message: '添加成功，管理员会在后台进行审核，审核通过后即可看到该想法！',
                            type:'success'
                        });
