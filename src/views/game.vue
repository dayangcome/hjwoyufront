        ...
        <div class="mycontainer">
            <div class="game-list">
                ...
                <div style="display: flex;flex-wrap: wrap;">
                    ...
                    <el-dialog title="游戏详情" :visible.sync="dialogTableVisible" width="40%">
                        ...
                        <div class="gamecard">
                            ...
                            <div class="gamecard-body">
                                ...
                                <div class="game-info">
                                <p>开发商: {{nowitem.manufacturer}}</p><br>
                                <p>游戏简介: {{nowitem.description}}</p>
                                </div>
                        ...
                        <div class="btn-container">
                                <button class="btn btn-start" @click="toweb(nowitem.playsrc)">启 动</button>
            ...
            <div style="display: flex;justify-content: center;">
                ...
                <el-button type="success" @click="addgames" plain style="margin: 10px 15px;"><i class="el-icon--left el-icon-plus"></i>添加游戏</el-button>
            </div>
            ...
            <el-form :model="gameForm" ref="gameForm" label-position="left" label-width="100px" label-align="left">
                ...
                <el-form-item label="游戏图片链接" prop="imageUrl">
                <el-input v-model="gameForm.imageUrl" required></el-input>
                </el-form-item>
                <el-form-item label="启动地址链接" prop="launchUrl">
                <el-input v-model="gameForm.launchUrl" required></el-input>
                </el-form-item>
            </el-form>
            <span style="color:rgb(0, 179, 255);">tips：请不要乱添加游戏哦！会有后台管理员进行审核，审核通过后即可看到该游戏，如有疑问，请联系管理员QQ：2012190160。</span>
            <!-- 按钮 -->
  ...
  import eventBus from './event-bus';
   export default{
    ...
    methods:{
        ...
        initdys(){
            ...
            if(this.nowuid!=null&&this.nowuid!=''){
                    ...
                    getdylike(1,this.nowuid).then(res=>{
                        if(res.data.code==200){
                    ...
                    getdydislike(1,this.nowuid).then(res=>{
                        if(res.data.code==200){
            ...
            if(this.gameForm.name.length<1){
                ...
                additem(game).then(res=>{
                    if(res.data.code!=200){
                        ...
                        this.$message({
                            message: '添加成功，管理员会在后台进行审核，审核通过后即可看到该游戏！',
                            type:'success'
                        });
    ...
    mounted(){
        ...
        console.log("欢迎您，来访者！\n由于作者技术有限，所以只能暂时支持每次展开一个讨论的评论，\n如果展开其他评论，则目前展开的评论会自动收起，敬请谅解！")
    },
    beforeDestroy(){
