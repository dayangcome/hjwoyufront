        ...
        <div class="mycontainer">
            <div class="game-list">
                ...
                <div style="display: grid;grid-template-columns: 1fr 1fr 1fr;">
                    ...
                    <el-dialog title="美食详情" :visible.sync="dialogTableVisible" width="40%">
                        ...
                        <div class="gamecard">
                            ...
                            <div class="gamecard-body">
                                ...
                                <p>美食简介: {{nowitem.description}}</p><br>
                                <p>价格描述: {{nowitem.manufacturer}}</p><br>
                                </div>
                        ...
                        <div class="btn-container">
                                <button class="btn btn-start" @click="toweb(nowitem.playsrc)">购 买</button>
            ...
            <div style="display: flex;justify-content: center;">
                ...
                <el-button type="success" @click="addgames" plain style="margin: 10px 15px;"><i class="el-icon--left el-icon-plus"></i>添加美食</el-button>
            </div>
            ...
            >
            <!-- 表单 -->
            <el-form :model="gameForm" ref="gameForm" label-position="left" label-width="100px" label-align="left">
                <el-form-item label="美食名称" prop="name">
                <el-input v-model="gameForm.name" required></el-input>
                </el-form-item>
                <el-form-item label="价格描述" prop="developer">
                <el-input v-model="gameForm.developer" required></el-input>
                </el-form-item>
                <el-form-item label="美食简介" prop="description">
                <el-input type="textarea" resize="none" v-model="gameForm.description" required></el-input>
                </el-form-item>
                <el-form-item label="美食图片链接" prop="imageUrl">
                <el-input v-model="gameForm.imageUrl" required></el-input>
                </el-form-item>
                <el-form-item label="购买链接" prop="launchUrl">
                <el-input v-model="gameForm.launchUrl" required></el-input>
                </el-form-item>
            </el-form>
            <span style="color:rgb(0, 179, 255);">tips：请不要乱添加美食哦！会有后台管理员进行审核，审核通过后即可看到该美食，如有疑问，请联系管理员QQ：2012190160。</span>
            <!-- 按钮 -->
    ...
    methods:{
        ...
        initdys(){
            ...
            if(this.nowuid!=null&&this.nowuid!=''){
                    ...
                    getdylike(2,this.nowuid).then(res=>{
                        if(res.data.code==200){
                    ...
                    getdydislike(2,this.nowuid).then(res=>{
                        if(res.data.code==200){
            ...
            if(this.gameForm.name.length<1){
                ...
                additem(game).then(res=>{
                    if(res.data.code!=200){
                        ...
                        this.$message({
                            message: '添加成功，管理员会在后台进行审核，审核通过后即可看到该美食！',
                            type:'success'
                        });
