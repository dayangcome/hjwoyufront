<template>
        ...
        <div class="mycontainer">
            <div class="game-list">
                ...
                <div style="display: grid;grid-template-columns: 1fr 1fr 1fr;">
                    ...
                    <el-dialog title="电影/电视剧详情" :visible.sync="dialogTableVisible" width="40%">
                        ...
                        <div class="gamecard">
                            ...
                            <div class="gamecard-body">
                                ...
                                <div class="game-info">
                                <p>演员阵容描述: {{nowitem.manufacturer}}</p><br>
                                <p>电影/电视剧简介: {{nowitem.description}}</p>
                                </div>
                        ...
                        <div class="btn-container">
                                <button class="btn btn-start" @click="toweb(nowitem.playsrc)">观 看</button>
            ...
            <div style="display: flex;justify-content: center;">
                ...
                <el-button type="success" @click="addgames" plain style="margin: 10px 15px;"><i class="el-icon--left el-icon-plus"></i>添加电影/电视剧</el-button>
            </div>
            ...
            <el-form :model="gameForm" ref="gameForm" label-position="left" label-width="150px" label-align="left">
                <el-form-item label="电影/电视剧名称" prop="name">
                <el-input v-model="gameForm.name" required></el-input>
                </el-form-item>
                <el-form-item label="演员阵容描述" prop="developer">
                <el-input v-model="gameForm.developer" required></el-input>
                </el-form-item>
                <el-form-item label="电影/电视剧简介" prop="description">
                <el-input type="textarea" resize="none" v-model="gameForm.description" required></el-input>
                </el-form-item>
                <el-form-item label="电影/电视剧封面链接" prop="imageUrl">
                <el-input v-model="gameForm.imageUrl" required></el-input>
                </el-form-item>
                <el-form-item label="观看链接" prop="launchUrl">
                <el-input v-model="gameForm.launchUrl" required></el-input>
                </el-form-item>
            </el-form>
            <span style="color:rgb(0, 179, 255);">tips：请不要乱添加电影/电视剧哦！会有后台管理员进行审核，审核通过后即可看到该电影/电视剧，如有疑问，请联系管理员QQ：2012190160。</span>
            <!-- 按钮 -->
    ...
    methods:{
        ...
        initdys(){
            ...
            if(this.nowuid!=null&&this.nowuid!=''){
                    ...
                    getdylike(3,this.nowuid).then(res=>{
                        if(res.data.code==200){
                    ...
                    getdydislike(3,this.nowuid).then(res=>{
                        if(res.data.code==200){
        ...
        submitForm() {
            ...
            if(this.gameForm.name.length<1){
                ...
                this.$message({
                    message: '请输入电影/电视剧封面链接',
                    type:'warning'
                });
            }else if(this.gameForm.launchUrl.length<1){
                this.$message({
                    message: '请输入电影/电视剧观看链接',
                    type:'warning'
                });
            }else if(this.gameForm.name.length>30){
                this.$message({
                    message: '电影/电视剧名称太长，请简化一下',
                    type:'warning'
                });
            }else if(this.gameForm.developer.length>30){

                this.$message({
                    message: '演员阵容描述太长，请简化一下',
                    type:'warning'
                });
            }else if(this.gameForm.description.length>1000){
                this.$message({
                    message: '电影/电视剧简介太长，请简化一下',
                    type:'warning'
                });
            }else if(this.gameForm.imageUrl.length>600){
                this.$message({
                    message: '电影/电视剧封面链接太长，请更换链接',
                    type:'warning'
                });
            }else if(this.gameForm.launchUrl.length>600){
                this.$message({
                    message: '电影/电视剧观看链接太长，请更换链接',
                    type:'warning'
                });
            }else{
                ...
                additem(game).then(res=>{
                    if(res.data.code!=200){
                        ...
                        this.$message({
                            message: '添加成功，管理员会在后台进行审核，审核通过后即可看到该电影/电视剧！',
                            type:'success'
                        });
  ...
  #outbox{
      ...
      background-image: url('https://pic.imgdb.cn/item/657d7471c458853aefd143e4.jpg');
